...
If you know QEMU/Python and want to support this project, you can [create a new fork](https://github.com/ChileCris2011/QEMUWin/fork), make all the changes you deem necessary, and create a pull request.  
